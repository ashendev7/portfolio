...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        <div
          className="bg-zinc-950 border border-zinc-800 rounded-2xl max-w-[280px] w-full overflow-hidden text-slate-100"
  ...
  if (!isMounted) {
    return (
      <div
        className="bg-zinc-900/40 rounded-lg animate-pulse flex items-center justify-center"
  ...
  if (!images.length) {
    return (
      <div
        className="bg-zinc-900/40 rounded-lg border-2 border-dashed border-zinc-800 flex items-center justify-center"
        style={{ width: containerSize, height: containerSize }}
      >
